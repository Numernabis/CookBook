...
public class CategoryCollectionTest {
    ...
    void serialize() throws IOException, UnnamedCookBookException {
        ...
        assertThrows(UnnamedCookBookException.class, () -> collection1.serialize("coll2.txt"));
    ...
    void renameCategory() throws NotFoundCategoryException, DuplicateCategoryException {
        ...
        assertThrows(DuplicateCategoryException.class, () -> collection2.renameCategory("dinner", "supper"));
        assertThrows(NotFoundCategoryException.class, () -> collection2.renameCategory("dinner&more", "supper"));
